...
class TravelTime:
    ...
    def __init__(self, json_response, **kwargs):
        ...
        self.origin = ''  # Google can change the given origin details, this is Google's version
        self.destination = ''
        self.distance = None  # default = meters
        self.duration = None  # default = seconds
    ...
    def feet(self):
        ...
        """
        return int(self.distance * 0.3408)
    ...
    def miles(self):
        ...
        """
        return int(self.distance / 1609.344)
